package com.example.xsecretchatclient.netty_chat_client.autowire;
...
public class AndroidAutowire {
     ...
     * <br />
     * After the call to {@code setContentView(layoutResID)} in the onCreate() method, you will
     * call
     ...
     *                  <br />
     *                  All views annotated with {@code @AndroidView} will be autowired in all
     *                  Activity classes
     *                  in the inheritance structure, from thisClass to baseClass inclusive.
     *                  baseClass should
     *                  not be {@link Activity} because no fields in {@link Activity} will need to
     *                  be autowired. <br />
     *                  <br />
     *                  If there is no parent class for your activity, use thisClass.class as
     *                  baseClass.
     * @throws AndroidAutowireException Indicates that there was an issue autowiring a view to an
     *                                  annotated field. Will not be thrown if required=false on the
     *                                  {@link AndroidView}
     *                                  annotation.
     */
...
//              + " found. " + " The required field " + field.getName() + " could not be autowired");
                ...
                throw new AndroidAutowireException(
                        "Cound not Autowire AndroidView: " + field.getName()
                                + ". " + e.getMessage());
            }
        }
    }
